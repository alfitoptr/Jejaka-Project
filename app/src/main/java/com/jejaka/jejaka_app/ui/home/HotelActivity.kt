...
import com.jejaka.jejaka_app.databinding.ActivityHotelBinding
import com.jejaka.jejaka_app.ui.detail_place.DetailPlaceActivity

class HotelActivity : AppCompatActivity() {

    private var _binding: ActivityHotelBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityHotelBinding.inflate(layoutInflater)
        ...
        binding.rvHotel.layoutManager = layoutManager

        homeViewModel.listPlaceHotel.observe(this){
            setListPlace(it)
        }
        ...
        homeViewModel.getRecommendHotel(
            "sksssaw", "Jakarta"
        )
    }
    ...
    private fun showRecyclerList() {
        ...
        adapter.setOnItemClickCallBack(object : CardAdapter.OnItemClickCallback{
            override fun onItemClicked(data: RecommendPlacesItem) {
                ...
                val intent = Intent(this@HotelActivity, DetailPlaceActivity::class.java)
